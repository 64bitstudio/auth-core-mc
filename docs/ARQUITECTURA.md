...
_Última actualización: al cerrar la tarea `008` (multi-tenencia: aislamiento probado, clonado a instancia dedicada vía export/import). Se actualizará con cada ticket movido a `/done`._
