...
_Última actualización: al cerrar la tarea `007` (servidor de autorización OAuth2 — grant directo con tokens reales, Authorization Code + PKCE, refresh/revoke). Se actualizará con cada ticket movido a `/done`._
