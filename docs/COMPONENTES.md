...
| Mi cuenta | `/ui/cuenta` | Sí | Hub post-login/registro: estado de verificación de correo + botón de reenvío, cambio de correo, OTP (request/verify), enroll/verify de TOTP, selector de método de 2FA preferido |
