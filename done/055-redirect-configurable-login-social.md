...
- **Facebook sigue sin configurar**: el `client_id` de Facebook que dio Marco no coincide con el guardado en `backend/.env` local (apps distintas) — pendiente de que confirme cuál usar o pase el secreto correcto.
