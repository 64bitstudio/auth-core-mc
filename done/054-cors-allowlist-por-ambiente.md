...
- **QA**: `CORS_ALLOWED_ORIGINS=https://studio-qa.galgoth.64bitstudio.com` ya agregado a `/home/ubuntu/secrets/auth-core-mc/.env.qa` en esta sesión — pendiente de que el pipeline promueva `dev`→`qa` y de repetir esta misma verificación ahí.
